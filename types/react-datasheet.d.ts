import { Component, KeyboardEventHandler, MouseEventHandler, ReactNode } from "react";
...
declare namespace ReactDataSheet {
    ...
    export type SheetRenderer<T extends Cell<T, V>, V = string> = React.ComponentClass<SheetRendererProps<T, V>> | React.FC<SheetRendererProps<T, V>>;
    ...
    export type RowRenderer<T extends Cell<T, V>, V = string> = React.ComponentClass<RowRendererProps<T, V>> | React.FC<RowRendererProps<T, V>>;
    ...
    export type CellRenderer<T extends Cell<T, V>, V = string> = React.ComponentClass<CellRendererProps<T, V>> | React.FC<CellRendererProps<T, V>>;
    ...
    export type ValueViewer<T extends Cell<T, V>, V = string> = React.ComponentClass<ValueViewerProps<T, V>> | React.FC<ValueViewerProps<T, V>>;
    ...
    export type DataEditor<T extends Cell<T, V>, V = string> = React.ComponentClass<DataEditorProps<T, V>> | React.FC<DataEditorProps<T, V>>;
